...
* @returns
*/
function numberFormate(input: string) {
 ...
 */
 function cal() {
     let value: string = getCurrentValue();
 ...
 */
function backspace() {
    const value: string = getCurrentValue();
    let valuelength: number = value.length;
    const newValue: string = value.substring(0, valuelength - 1);
 ...
 */
function plusminus() {
    let value: number = Number (getCurrentValue());
    value *= -1;
 ...
 */
function ln() {
    const value: number = Number(getCurrentValue());
...
/** function factorial() {
    ...
    /*if(value == 0){
        ...
        retuen value * factorial ( value -1 );
    }
    */
...
function calExp() {
    const value: number = Number(getCurrentValue());
    operation.innerText = String(Math.exp(value));
}
//-------------------------------------------Exp End----------------------------------------------------
...
function absolute() {
    const value: number = Number(getCurrentValue());
    operation.innerText = String(Math.abs(value));
}
//-------------------------------------------Absolute End-----------------------------------------------
...
let myFunction : mathFunction;

myFunction = function mathsFunction(functionName: string) {
    let value: number = Number(getCurrentValue());
    let result: number = 0;
    switch (functionName) {
        case 'ceil':
...
let myTrigonometry: Trigonometry
myTrigonometry = function trigonometry(method: string) {
    let value: number = Number(getCurrentValue());
    let result: number;
    switch (method) {
        case "sin":
